...
namespace AgendaMedica.Controllers
{
    public class AgendaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AgendaId,PacienteId,MedicoId,DataConsulta,Status")] Agenda agenda)
        {
            ...
            ViewData["MedicoId"] = new SelectList(_context.Medico, "MedicoId", "MedicoId", agenda.MedicoId);
            ViewData["PacienteId"] = new SelectList(_context.Paciente, "PacienteId", "PacienteId", agenda.PacienteId);
            return View(agenda);
        }
